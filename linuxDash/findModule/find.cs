...
using System.Linq;
namespace linuxDash.findModule
{
    public class find
    {
        ...
        public static void findItem(string item)
        {
            ...
            List<directory> directories = JsonConvert.DeserializeObject<List<directory>>(File.ReadAllText("sharedData/directories/directories.json"));
